                                        ...
                                        <Button
                                            ...
                                            onClick={() => {
                                                if (result.type === ADMIN) {
                                                    router.push(`/dashboard/student/responses?id=${result.id}&mock=${result.isMock}&studentId=${userId}`);
                                                } else {
                                                    router.push(`/dashboard/student/user-responses?id=${result.quizId || result.id}`);
                                                }
                                            }}
                                        >
                                            View Responses
