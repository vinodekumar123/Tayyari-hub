  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {/* Quiz Grid */}
        {quizzes.length === 0 ? (
          <div className="relative bg-white dark:bg-slate-900 rounded-3xl p-16 text-center shadow-2xl border border-blue-100 dark:border-slate-800">
            ...
            <div className="relative">
              <div className="inline-flex p-8 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-3xl mb-6 shadow-lg">
                <FileQuestion className="h-20 w-20 text-blue-600 dark:text-blue-400" />
              </div>
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">No Quizzes Yet</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {quizzes.map((q) => {
              ...
              return (
                <div
                  key={q.id}
                  className="group relative bg-white dark:bg-slate-900/50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border border-gray-100 dark:border-slate-800"
                >
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="flex items-center gap-3 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-4 border border-blue-100 dark:border-blue-900/30">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 dark:text-gray-100 text-2xl font-bold">{q.questionCount}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-4 border border-purple-100 dark:border-purple-900/30">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 dark:text-gray-100 text-2xl font-bold">{q.duration} min</p>
                        </div>
                      </div>
                    </div>
