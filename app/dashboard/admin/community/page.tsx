    ...
    const handleCreatePost = async () => {
        ...
        try {
            ...
            await addDoc(collection(db, 'forum_posts'), {
                ...
                tags: [],
                authorId: user?.uid,
                authorName: user?.fullName || 'Admin', // Fallback
                authorRole: 'admin', // In real app, check claims
                upvotes: 0,
                upvotedBy: [],
                replyCount: 0,
                isSolved: false,
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div>
                            ...
                            <p className="text-muted-foreground font-semibold flex items-center gap-2">
                                ...
                                Moderate discussions and announcements
                            </p>
                        </div>
                        ...
                        <Dialog>
                            <DialogTrigger asChild>
                                <Button className="bg-gradient-to-r from-[#004AAD] to-[#0066FF] hover:shadow-lg hover:shadow-blue-500/25 transition-all text-white border-none">
                                    <Plus className="mr-2 h-5 w-5" /> New Announcement
                                </Button>
                            </DialogTrigger>
                            <DialogContent className="sm:max-w-[600px]">
                                ...
                                <div className="space-y-4 py-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input value={newTitle} onChange={e => setNewTitle(e.target.value)} placeholder="e.g. Schedule for Monthly Tests" />
                                    </div>
                                    <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea value={newContent} onChange={e => setNewContent(e.target.value)} placeholder="Announcement details..." className="min-h-[150px]" />
                                    </div>
                                    <Button className="w-full" onClick={handleCreatePost} disabled={isAsking}>
                                        {isAsking ? 'Posting...' : 'Post Announcement'}
                                    </Button>
                                </div>
                            </DialogContent>
                        </Dialog>
