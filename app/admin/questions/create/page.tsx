              ...
              <CardContent className="space-y-6">
                {previewMode ? (
                  <div className="p-4 bg-gray-100 rounded-lg">
                    <div
                      className="text-lg font-medium text-gray-800 prose"
                    ...
                    {questionData.enableExplanation && questionData.explanation && (
                      <div className="mt-4">
                        <p className="text-lg font-medium text-gray-700">Explanation:</p>
                        <p className="text-lg text-gray-600">{questionData.explanation}</p>
                      </div>
                    )}
                  </div>
                ) : (
