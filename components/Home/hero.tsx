...
import l1 from "/app/assets/hero.png";
    ...
    <section className="relative bg-white overflow-hidden min-h-screen flex items-center justify-center px-4 sm:px-6 py-20">
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative flex justify-center items-center w-full mt-10 md:mt-0">
          ...
          {/* Floating Widgets */}
          <div className="absolute top-0 left-0 hero-float">
            <div className="backdrop-blur-lg bg-white/80 px-4 py-2 rounded-xl shadow text-2xl text-gray-800">
              <strong className="text-blue-600 text-4xl hero-counter" data-target="75000">
                🎓 7129
              </strong>
              <br />
              Students Enrolled
          ...
          <div className="absolute bottom-4 left-0 hero-float-delay">
            <div className="backdrop-blur-lg bg-white/80 px-4 py-2 rounded-xl shadow text-2xl text-gray-800">
              <strong className="text-blue-600 text-4xl hero-counter" data-target="250">
                📚 4
              </strong>
              <br />
              Courses
          ...
          <div className="absolute bottom-2 right-2 hero-float">
            <div className="backdrop-blur-lg bg-white/80 px-4 py-2 rounded-xl shadow text-2xl text-gray-800">
              <strong className="text-blue-600 text-4xl hero-counter" data-target="3500">
                📃 13056
              </strong>
              <br />
              Tests Created
