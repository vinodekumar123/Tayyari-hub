            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <div
                  key={index}
                  data-index={index}
                  className={`benefit-item group relative bg-white/90 backdrop-blur-lg rounded-2xl p-6 hover:bg-white hover:shadow-xl transition-all duration-700 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                    }`}
                  style={{
