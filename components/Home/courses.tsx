      ...
      <div className="relative max-w-8xl mx-auto w-full">
              ...
              `}>
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <div className="mt-auto">
                    <button className={`w-full py-4 rounded-2xl font-bold transition-all duration-300 flex items-center justify-center gap-3 ${
                      activeCard === index
        ...
        <div className="text-center">
          <div className="inline-flex flex-col items-center gap-8">
            <button className="group relative px-16 py-5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-2xl font-bold text-xl text-white shadow-2xl shadow-blue-500/25 transition-all duration-300 hover:scale-105 hover:shadow-blue-500/40">
