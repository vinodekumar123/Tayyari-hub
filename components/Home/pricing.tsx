      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/95 backdrop-blur-xl border border-white/30 rounded-3xl p-10 shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:-translate-y-2">
              {/* Plan Icon */}
              ...
              <Link
                href="/auth/register"
                className="group/btn relative block w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
              >
          ...
          <div className="group relative">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white rounded-3xl p-10 shadow-3xl border border-white/20 backdrop-blur-xl hover:scale-[1.02] transition-all duration-500 overflow-hidden">
              ...
              <Link
                href="/pricing"
                className="group/btn relative block w-full px-8 py-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
              >
